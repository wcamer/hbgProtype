...
public static class CardFactory
{
    ...
    public static Dictionary<int, Card> CreateCardIndex()
    {
        ...
        Add(new Card { Name = "Utility Wand", Type = CardType.Item, Cost = 3, Text = "+1 influence.", ImageKey = "item", Effect = new CardEffect { Resources = new() { new ResourceDelta { Type = ResourceType.Influence, Amount = 1 } } } });
